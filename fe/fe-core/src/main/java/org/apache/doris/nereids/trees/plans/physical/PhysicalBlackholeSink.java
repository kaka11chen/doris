 ...
 * result sink
 */
public class PhysicalBlackholeSink<CHILD_TYPE extends Plan> extends PhysicalSink<CHILD_TYPE>
        implements Sink, ComputeResultSet {

    public PhysicalBlackholeSink(List<NamedExpression> outputExprs, Optional<GroupExpression> groupExpression,
    ...
    @Override
    public PhysicalBlackholeSink<Plan> withGroupExprLogicalPropChildren(Optional<GroupExpression> groupExpression,
