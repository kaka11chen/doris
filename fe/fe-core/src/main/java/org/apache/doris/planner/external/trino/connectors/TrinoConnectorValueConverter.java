...
/**
 * Convert LiteralExpr to trino connector value.
 */
public class TrinoConnectorValueConverter extends DataTypeDefaultVisitor<Object> {
    private LiteralExpr expr;

    public TrinoConnectorValueConverter(LiteralExpr expr) {
        this.expr = expr;
    }
