...
/**
 * BlackholeSink for WARM UP SELECT operations.
 * This sink discards all input data while allowing cache population.
 * Used to warm up cache without returning results to the client.
 */
public class BlackholeSink extends DataSink {
    ...
    protected TDataSink toThrift() {
        ...
        tBlackholeSink.setEnableCacheMetrics(enableCacheMetrics);
        tBlackholeSink.setProperties(properties);
