...
//     RleBatchDecoder<uint32_t> dec(reinterpret_cast<uint8_t*>(const_cast<char*>(buf.data())), buf.size(), 2);
...
//     RleBatchDecoder<uint32_t> dec(reinterpret_cast<uint8_t*>(const_cast<char*>(buf.data())), truncated_len, 2);
