...
template class AsyncWriterSink<doris::vectorized::VIcebergDeleteSink, IcebergDeleteSinkOperatorX>;
template class AsyncWriterSink<doris::vectorized::VIcebergMergeSink, IcebergMergeSinkOperatorX>;
