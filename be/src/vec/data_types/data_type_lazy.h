...
// https://github.com/ClickHouse/ClickHouse/blob/master/src/DataTypes/DataTypeLazy.h
...
#include "vec/data_types/serde/data_type_lazy_serde.h"
...
class DataTypeLazy final : public IDataType {
public:
    explicit DataTypeLazy(const DataTypePtr& nested_data_type_);
    std::string do_get_name() const override {
        return "Lazy(" + nested_data_type->get_name() + ")";
    }
    const char* get_family_name() const override { return "Lazy"; }
    TypeIndex get_type_id() const override { return TypeIndex::Lazy; }
    ...
    DataTypeSerDeSPtr get_serde(int nesting_level = 1) const override {
        return std::make_shared<DataTypeLazySerde>();
    }
