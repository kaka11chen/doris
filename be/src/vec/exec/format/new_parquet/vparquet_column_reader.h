...
public:
    ...
    virtual Status read_column_data(ColumnPtr& doris_column, DataTypePtr& type,
                                    ...
                                    converter::ColumnTypeConverterFactory* convert_factory) = 0;
...
public:
    ...
    Status read_column_data(ColumnPtr& doris_column, DataTypePtr& type,
                            ...
                            bool is_dict_filter,
                            converter::ColumnTypeConverterFactory* convert_factory) override;
...
private:
    ...
    std::unique_ptr<PhysicalToLogicalConverter> _converter = nullptr;
