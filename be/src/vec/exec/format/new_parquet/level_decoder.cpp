...
doris::Status doris::vectorized::new_parquet::LevelDecoder::init(doris::Slice* slice,
...
doris::Status doris::vectorized::new_parquet::LevelDecoder::init_v2(const doris::Slice& levels,
                                                                    level_t max_level,
                                                                    uint32_t num_levels) {
...
size_t doris::vectorized::new_parquet::LevelDecoder::get_levels(level_t* levels, size_t n) {
