...
#include "vec/exec/format/new_parquet/decoder.h"

#include <cctz/time_zone.h>
#include <gen_cpp/parquet_types.h>

#include "vec/exec/format/new_parquet/bool_plain_decoder.h"
#include "vec/exec/format/new_parquet/bool_rle_decoder.h"
#include "vec/exec/format/new_parquet/byte_array_dict_decoder.h"
#include "vec/exec/format/new_parquet/byte_array_plain_decoder.h"
#include "vec/exec/format/new_parquet/byte_stream_split_decoder.h"
#include "vec/exec/format/new_parquet/delta_bit_pack_decoder.h"
#include "vec/exec/format/new_parquet/fix_length_dict_decoder.hpp"
#include "vec/exec/format/new_parquet/fix_length_plain_decoder.h"
