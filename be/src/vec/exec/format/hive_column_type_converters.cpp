...
std::unique_ptr<ColumnTypeConverter> HiveColumnTypeConverterFactory::_numeric_converter(
...
std::unique_ptr<ColumnTypeConverter> HiveColumnTypeConverterFactory::_to_string_converter(
        const DataTypePtr& src_type, const DataTypePtr& dst_type) {
    PrimitiveType src_primitive_type = src_type->get_primitive_type();
...
template <FileFormat fileFormat>
std::unique_ptr<ColumnTypeConverter> HiveColumnTypeConverterFactory::_from_string_converter(
        const DataTypePtr& src_type, const DataTypePtr& dst_type) {
    PrimitiveType dst_primitive_type = dst_type->get_primitive_type();
    switch (dst_primitive_type) {
#define DISPATCH(DST_PTYPE)                                                  \
...
std::unique_ptr<ColumnTypeConverter> HiveColumnTypeConverterFactory::_numeric_to_decimal_converter(
        const DataTypePtr& src_type, const DataTypePtr& dst_type) {
    PrimitiveType src_primitive_type = src_type->get_primitive_type();
    PrimitiveType dst_primitive_type = dst_type->get_primitive_type();
...
std::unique_ptr<ColumnTypeConverter> HiveColumnTypeConverterFactory::_datetime_to_numeric_converter(
        const DataTypePtr& src_type, const DataTypePtr& dst_type) {
    PrimitiveType dst_primitive_type = dst_type->get_primitive_type();
...
std::unique_ptr<ColumnTypeConverter> HiveColumnTypeConverterFactory::_decimal_to_numeric_converter(
        const DataTypePtr& src_type, const DataTypePtr& dst_type) {
    PrimitiveType src_primitive_type = src_type->get_primitive_type();
    PrimitiveType dst_primitive_type = dst_type->get_primitive_type();
...
std::unique_ptr<ColumnTypeConverter> HiveColumnTypeConverterFactory::_decimal_converter(
        const DataTypePtr& src_type, const DataTypePtr& dst_type) {
...
static std::shared_ptr<ColumnTypeConverterFactory> hive_factory = nullptr;

// ============== Factory Instance Methods ==============

std::shared_ptr<ColumnTypeConverterFactory> HiveColumnTypeConverterFactory::instance() {
    if (!hive_factory) {
        hive_factory = std::make_shared<HiveColumnTypeConverterFactory>();
    }
    return hive_factory;
}

// ============== Hive Factory Implementation ==============

std::unique_ptr<ColumnTypeConverter> HiveColumnTypeConverterFactory::create_converter(
        const DataTypePtr& src_type, const DataTypePtr& dst_type, FileFormat file_format) {
    PrimitiveType src_primitive_type = src_type->get_primitive_type();
    PrimitiveType dst_primitive_type = dst_type->get_primitive_type();
