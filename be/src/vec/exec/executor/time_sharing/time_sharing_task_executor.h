...
public:
    ...
    size_t running_splits_size() const {
        return _running_splits.size();
    }

    size_t blocked_splits_size() const {
        return _blocked_splits.size();
    }
    ...
    int64_t completed_tasks_level0() const {
        return _completed_tasks_per_level[0];
    }

    int64_t completed_tasks_level1() const {
        return _completed_tasks_per_level[1];
    }

    int64_t completed_tasks_level2() const {
        return _completed_tasks_per_level[2];
    }

    int64_t completed_tasks_level3() const {
        return _completed_tasks_per_level[3];
    }

    int64_t completed_tasks_level4() const {
        return _completed_tasks_per_level[4];
    }

    int64_t completed_splits_level0() const {
        return _completed_splits_per_level[0];
    }

    int64_t completed_splits_level1() const {
        return _completed_splits_per_level[1];
    }

    int64_t completed_splits_level2() const {
        return _completed_splits_per_level[2];
    }

    int64_t completed_splits_level3() const {
        return _completed_splits_per_level[3];
    }

    int64_t completed_splits_level4() const {
        return _completed_splits_per_level[4];
    }

    int64_t running_tasks_level0() const {
        return _get_running_tasks_for_level(0);
    }

    int64_t running_tasks_level1() const {
        return _get_running_tasks_for_level(1);
    }

    int64_t running_tasks_level2() const {
        return _get_running_tasks_for_level(2);
    }

    int64_t running_tasks_level3() const {
        return _get_running_tasks_for_level(3);
    }

    int64_t running_tasks_level4() const {
        return _get_running_tasks_for_level(4);
    }
