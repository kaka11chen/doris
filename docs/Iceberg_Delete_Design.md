...
- Operation codes (FE):
  ...
  - `UPDATE_OPERATION_NUMBER = 3`
  - `UPDATE_INSERT_OPERATION_NUMBER = 4`
  - `UPDATE_DELETE_OPERATION_NUMBER = 5`
...
Code:
- FE type definition: `fe/fe-core/src/main/java/org/apache/doris/datasource/iceberg/IcebergMetadataColumn.java`
...
3. `IcebergDeleteCommand` enables `needIcebergRowId` in session variable.
...
- `fe/fe-core/src/main/java/org/apache/doris/datasource/iceberg/IcebergTransaction.java`
- `fe/fe-core/src/main/java/org/apache/doris/datasource/iceberg/helper/IcebergWriterHelper.java`
- `fe/fe-core/src/main/java/org/apache/doris/datasource/iceberg/IcebergMetadataColumn.java`
